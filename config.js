...
const OWNER_NAME   = 'Lunaa';
const NOMOR_BOT    = '6287738783423'; // 628xx nomor wa
...
const WEBSITE      = '';
const DATA_OWNER   = ['6285868755849']; // bisa juga edit di database/owner.json
...
const config = {
    ...
    status_prefix       : false, // harus pake prefix g?
    prefix              : ['.','!','#'],
    sticker_packname    : 'rowrr',
    sticker_author      : 'someone',
    mode                : MODE,
